...
<body>
  <?php include("include/header.php");?>
	...
	<h1>accessories List / Page <?php echo $page;?></h1></div><br>
...
<a class=' btn btn-success' href='accessories_list.php?product_id=$product_id&action=delete'>Delete</a>
</td></tr>";
}
...
<li><a class="label-info" href="accessories_list.php?page=<?php echo $b;?>"><?php echo $b." ";?></a></li></ul>
<?php	
}
?>
</nav>
