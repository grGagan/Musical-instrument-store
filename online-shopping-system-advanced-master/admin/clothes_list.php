...
<a class=' btn btn-success' href='instruments_list.php?product_id=$product_id&action=delete'>Delete</a>
</td></tr>";
}
...
<li><a class="label-info" href="instruments_list.php?page=<?php echo $b;?>"><?php echo $b." ";?></a></li></ul>
<?php	
}
?>
</nav>
